...
function Raporty({operacje,kontrahenci,opakowania}){
 const [od,setOd]=useState(''),[doo,setDoo]=useState(today()),[kon,setKon]=useState(''),[opak,setOpak]=useState(''),[show,setShow]=useState(false);
